...
2. Git отслеживает файлы по имени! Если изменить имя файла, необходимо добавить файл с новый именем + __*git commit*__
...
Язык разметки Markdown имеет множество особенностей и функций, которым можно найти самые разные способы применения. С более подробной, а также дополнительной информацией по веткам в Git вы можете ознакомиться по ссылкам:
